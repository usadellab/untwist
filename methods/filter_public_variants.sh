...
/mnt/bin/bcftools/bcftools-1.9/bcftools view -v snps --threads 20 -i 'QUAL>20 && FORMAT/DP>3' -O z -o results/NC_all_gatk_CAM_casom_CAMPUB223_54UNT_bcftools_filtered.vcf.gz material/NC_all_gatk_CAM_casom_CAMPUB223_54UNT.vcf;
