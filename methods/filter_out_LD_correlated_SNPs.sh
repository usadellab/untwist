...
/mnt/bin/bcftools/bcftools-1.9/bcftools +prune -l0.4 -Oz -o ./results/all_public_and_all_untwist_SNP_filtered.vcf.gz ./results/all_public_and_all_untwist_SNP_filtered_from_ata.vcf.gz;
